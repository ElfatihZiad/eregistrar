...
extended as further analysis and design artifacts are produced. This deck covers
the artifacts from Labs 1–5 plus the Lab 7 implementation slice.

## Structure (11 slides, ~10 minutes)
...
overflow. It was **not** visually rendered here, because LibreOffice is not
installed on this machine, so open it once in PowerPoint or Keynote to confirm
the fonts and image placement look right on your projector.
